...
(function() {
  var createMap, getStyles, getLegend;
  ...
  createMap = function() {
    ...
    return $.getJSON(urlJson, function(data) {
      var baseLayer, layers, styles, infoTag, subtitle, elemTag;
      ...
      formElem = document.getElementById("elemProj");
  ...
  getLegend = function(info, tagId){
    tagId.innerHTML = info;
    tagId.removeChild(tagId.lastChild);
  }

  getLegend(infoTag, subtitle);
