...
#      #8854
#      urljson = 'http://10.1.25.80:10001/geoserver/siga/ows?service=WFS&version=1.1.0&request=GetFeature&typeName=siga:CI_CANTEIRO_OBRA&maxFeatures=50&cql_filter=CD_PROGRESSAO_EMPREENDIMENTO=9816&outputFormat=text/javascript&format_options=callback:loadFeatures&srsname=EPSG:3857'
#      $.ajax
#        url: urljson
#        dataType: 'jsonp'
